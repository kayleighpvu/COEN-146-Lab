...
//	Description: This program computes the opening, reading, and writing of given text/binary files and system calls. 
//				 Then the program calculates the time performed by the copying process the code performs.
...
int main(int argc, char* argv[]) {
	...
	check_copy_times(source, destination);
	return 0;
}