...
* Name: Kayleigh Vu
* Date: 05/09/2023
* Title: Lab5 - UDP Server
* Description: This program is the UDP server which receives the packets from the client, if the checksum and sequence number is correct,
* will send an ACK (acknowledgement) back to the client for the client to send another packet of the file.  If checksum and/or sequence 
* number is not correct, the server will tell that there was a incorrect checksum and/or incorrect sequence num and have the re-receive
* the packet from the client again.
*/
